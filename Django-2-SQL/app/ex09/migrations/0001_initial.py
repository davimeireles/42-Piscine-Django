# Generated by Django 5.1.4 on 2025-04-25 15:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('homeworld', models.ForeignKey(blank=True, db_column='homeworld', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='residents', to='ex09.planets')),
            ],
        ),
    ]
